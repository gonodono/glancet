...
internal data class MethodModification(
    ...
    val featureSwitch: GlimpsePluginExtension.() -> Property<Boolean>,
    ...
    fun isMatch(className: String, extension: GlimpsePluginExtension): Boolean =
...
private val RemoteAdapterModification =
    MethodModification(
        featureName =
            "remoteAdapter",
        featureSwitch =
            GlimpsePluginExtension::remoteAdapter,
        createMethodVisitor =
            ::RemoteAdapterAdvice,
...
private val ScrollableLazyColumnModification =
    MethodModification(
        featureName =
            "scrollableLazyColumn",
        featureSwitch =
            GlimpsePluginExtension::scrollableLazyColumn,
        createMethodVisitor =
            ::ScrollableLazyAdvice,
        targetClassFullyQualifiedName =
...
private val ScrollableLazyVerticalGridModification =
    MethodModification(
        featureName =
            "scrollableLazyVerticalGrid",
        featureSwitch =
            GlimpsePluginExtension::scrollableLazyVerticalGrid,
        createMethodVisitor =
            ::ScrollableLazyAdvice,
        targetClassFullyQualifiedName =
...
internal class ScrollableLazyAdvice(
    api: Int,
    methodVisitor: MethodVisitor,
    access: Int,
    name: String?,
    ...
    override fun afterMethod() {
        ...
        visitMethodInsn(
            ...
            INVOKESTATIC,
            /* owner = */
            "dev/gonodono/glimpse/scrollablelazy/ScrollableLazyModifierKt",
            /* name = */
            "applyScrollableLazyIfPresent",
            /* descriptor = */
            "(Landroid/widget/RemoteViews;" +
                    "Landroidx/glance/GlanceModifier;" +
                    "I" +
...
internal val Modifications: Set<MethodModification> =
    setOf(
        ...
        ScrollableLazyColumnModification,
        ScrollableLazyVerticalGridModification
    )