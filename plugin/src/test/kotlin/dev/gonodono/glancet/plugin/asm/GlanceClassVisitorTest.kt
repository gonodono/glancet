...
import dev.gonodono.glancet.plugin.TestVariantName
import dev.gonodono.glancet.plugin.glancetApplicationProject
...
class GlanceClassVisitorTest {
    ...
    fun factoryIsInstrumentable() {
        ...
        val extension = extensions.getByType(GlancetPluginExtension::class.java)
...
private class TestFactoryParameters(
    ...
    pluginExtension: GlancetPluginExtension
) : GlanceClassVisitor.Factory.Parameters {

    override val extension: Property<GlancetPluginExtension> =
        objectFactory.property(GlancetPluginExtension::class.java)
