...
import dev.gonodono.glimpse.demo.internal.ActionItemClick
import dev.gonodono.glimpse.demo.internal.ExtraItemPosition
import dev.gonodono.glimpse.demo.internal.ItemCount
import dev.gonodono.glimpse.demo.internal.SimpleNavigationFrame
import dev.gonodono.glimpse.demo.internal.appWidgetIdExtra
import dev.gonodono.glimpse.demo.internal.debugLog
import dev.gonodono.glimpse.demo.internal.displayName
import dev.gonodono.glimpse.demo.internal.setDataToSelfUri
...
import dev.gonodono.glimpse.remoteadapter.AdapterViewType
import dev.gonodono.glimpse.remoteadapter.rememberAdapterViewFlipperState
import dev.gonodono.glimpse.remoteadapter.rememberGridViewState
...
abstract class RemoteAdapterWidgetReceiver(
    ...
    final override fun onReceive(context: Context, intent: Intent) =
        if (intent.action == ActionItemClick) {
            ...
            debugLog(name, appWidgetId, position)
        } else {
