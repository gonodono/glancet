...
import dev.gonodono.glimpse.demo.internal.appSettings
import dev.gonodono.glimpse.demo.internal.appWidgetManager
import dev.gonodono.glimpse.demo.internal.canPinAppWidgets
import dev.gonodono.glimpse.demo.internal.displayName
import dev.gonodono.glimpse.demo.internal.isComponentEnabled
...
@Composable
private fun ScrollableLazyContent() {
    OutlinedCard(
        modifier = Modifier
            .fillMaxWidth()
            .wrapContentHeight()
        ...
        Column(
            ...
            PinButton(ScrollableLazyColumnWidgetReceiver::class.java)
            PinButton(ScrollableLazyVerticalGridWidgetReceiver::class.java)
        }
    }
}
