...
import dev.gonodono.glimpse.demo.BuildConfig
...
internal fun debugLog(name: String, appWidgetId: Int, index: Int) {
    if (!BuildConfig.DEBUG) return
    Log.d(Tag, "$name: appWidgetID=$appWidgetId, position=$index")
}
