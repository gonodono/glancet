...
internal inline fun <T : GlanceModifier> assertModifierPresent(
    ...
    runGlanceAppWidgetUnitTest {
        provideComposable {
            block(GlanceModifier.semantics { testTag = GlimpseTestTag })
        }
        onNode(hasTestTag(GlimpseTestTag)).assert(
            GlanceNodeMatcher("hasScrollableLazyModifier") { node ->
...
private const val GlimpseTestTag = "GlimpseTestTag"